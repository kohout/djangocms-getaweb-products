...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'djangocms_product_order', 'country',
                      self.gf('django.db.models.fields.CharField')(default='AT', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.country'
        db.delete_column(u'djangocms_product_order', 'country')
