...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductCategory.order'
        db.add_column(u'djangocms_product_productcategory', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProductCategory.section'
        db.add_column(u'djangocms_product_productcategory', 'section',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=50, blank=True),
                      keep_default=False)

        ## Adding field 'ProductCategory.slug'
        #db.add_column(u'djangocms_product_productcategory', 'slug',
        #              self.gf('django.db.models.fields.SlugField')(default=u'-', unique=True, max_length=255),
        #              keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductCategory.order'
        db.delete_column(u'djangocms_product_productcategory', 'order')

        # Deleting field 'ProductCategory.section'
        db.delete_column(u'djangocms_product_productcategory', 'section')

        # Deleting field 'ProductCategory.slug'
        db.delete_column(u'djangocms_product_productcategory', 'slug')
