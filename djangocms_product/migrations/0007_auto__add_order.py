...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Order'
        db.create_table(u'djangocms_product_order', (
            ...
            ('telephone', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=5)),
        ))
        db.send_create_signal(u'djangocms_product', ['Order'])


    def backwards(self, orm):
        # Deleting model 'Order'
        db.delete_table(u'djangocms_product_order')
