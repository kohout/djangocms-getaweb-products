...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'djangocms_product_order', 'total_amount',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'Order.shipping_amount'
        db.add_column(u'djangocms_product_order', 'shipping_amount',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'Order.shipping_label'
        db.add_column(u'djangocms_product_order', 'shipping_label',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=150, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.total_amount'
        db.delete_column(u'djangocms_product_order', 'total_amount')

        # Deleting field 'Order.shipping_amount'
        db.delete_column(u'djangocms_product_order', 'shipping_amount')

        # Deleting field 'Order.shipping_label'
        db.delete_column(u'djangocms_product_order', 'shipping_label')
    ...
    models = {
        ...
        u'djangocms_product.order': {
            'Meta': {'object_name': 'Order'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'city': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'country': ('django.db.models.fields.CharField', [], {'default': "'AT'", 'max_length': '100'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '150'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'shipping_amount': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
            'shipping_label': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '150', 'blank': 'True'}),
            'telephone': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'total_amount': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
            'zipcode': ('django.db.models.fields.CharField', [], {'max_length': '5'})
        },
        u'djangocms_product.ordereditem': {
            'Meta': {'object_name': 'OrderedItem'},
            'amount': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['djangocms_product.Order']"}),
        ...
        u'djangocms_product.productcategory': {
            ...
            'section': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '50', 'blank': 'True'}),
        ...
        u'djangocms_product.productitem': {
            ...
            'target_page': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['cms.Page']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'})
        },
