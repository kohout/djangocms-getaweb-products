...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductItem.out_of_stock'
        db.add_column(u'djangocms_product_productitem', 'out_of_stock',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductItem.out_of_stock'
        db.delete_column(u'djangocms_product_productitem', 'out_of_stock')
