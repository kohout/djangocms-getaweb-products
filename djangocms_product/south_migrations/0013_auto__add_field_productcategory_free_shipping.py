...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductCategory.free_shipping'
        db.add_column(u'djangocms_product_productcategory', 'free_shipping',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductCategory.free_shipping'
        db.delete_column(u'djangocms_product_productcategory', 'free_shipping')
    ...
    models = {
        ...
        u'djangocms_product.order': {
            ...
            'country': ('django.db.models.fields.CharField', [], {'default': "'AT'", 'max_length': '100', 'blank': 'True'}),
