...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderedItem.product_item'
        db.add_column(u'djangocms_product_ordereditem', 'product_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['djangocms_product.ProductItem']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderedItem.product_item'
        db.delete_column(u'djangocms_product_ordereditem', 'product_item_id')
