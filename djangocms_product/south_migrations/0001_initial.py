...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djangocms_product_productcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'djangocms_product', ['ProductCategory'])

        # Adding model 'ProductItem'
        db.create_table(u'djangocms_product_productitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('special_offer', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('target_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'])),
            ('document', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'djangocms_product', ['ProductItem'])

        # Adding M2M table for field product_categories on 'ProductItem'
        m2m_table_name = db.shorten_name(u'djangocms_product_productitem_product_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productitem', models.ForeignKey(orm[u'djangocms_product.productitem'], null=False)),
            ('productcategory', models.ForeignKey(orm[u'djangocms_product.productcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['productitem_id', 'productcategory_id'])

        # Adding model 'ProductTeaser'
        db.create_table(u'djangocms_product_productteaser', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('ordering', self.gf('django.db.models.fields.CharField')(default='past_desc', max_length=20)),
            ('target_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'])),
        ))
        db.send_create_signal(u'djangocms_product', ['ProductTeaser'])

        # Adding M2M table for field product_categories on 'ProductTeaser'
        m2m_table_name = db.shorten_name(u'djangocms_product_productteaser_product_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productteaser', models.ForeignKey(orm[u'djangocms_product.productteaser'], null=False)),
            ('productcategory', models.ForeignKey(orm[u'djangocms_product.productcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['productteaser_id', 'productcategory_id'])

        # Adding model 'ProductImage'
        db.create_table(u'djangocms_product_productimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('product_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djangocms_product.ProductItem'])),
        ))
        db.send_create_signal(u'djangocms_product', ['ProductImage'])


    def backwards(self, orm):
        # Deleting model 'ProductCategory'
        db.delete_table(u'djangocms_product_productcategory')

        # Deleting model 'ProductItem'
        db.delete_table(u'djangocms_product_productitem')

        # Removing M2M table for field product_categories on 'ProductItem'
        db.delete_table(db.shorten_name(u'djangocms_product_productitem_product_categories'))

        # Deleting model 'ProductTeaser'
        db.delete_table(u'djangocms_product_productteaser')

        # Removing M2M table for field product_categories on 'ProductTeaser'
        db.delete_table(db.shorten_name(u'djangocms_product_productteaser_product_categories'))

        # Deleting model 'ProductImage'
        db.delete_table(u'djangocms_product_productimage')
    ...
    models = {
        ...
        u'djangocms_product.productitem': {
            ...
            'special_offer': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
