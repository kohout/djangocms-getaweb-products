...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djangocms_product_order', 'city', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Order.telephone'
        db.alter_column(u'djangocms_product_order', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Order.email'
        db.alter_column(u'djangocms_product_order', 'email', self.gf('django.db.models.fields.EmailField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Order.city'
        db.alter_column(u'djangocms_product_order', 'city', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Order.telephone'
        db.alter_column(u'djangocms_product_order', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Order.email'
        db.alter_column(u'djangocms_product_order', 'email', self.gf('django.db.models.fields.EmailField')(max_length=5))
