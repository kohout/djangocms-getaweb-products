...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductItem.order'
        db.add_column(u'djangocms_product_productitem', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductItem.order'
        db.delete_column(u'djangocms_product_productitem', 'order')
